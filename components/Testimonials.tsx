...
const Testimonials: React.FC = () => {
  return (
    <section className="py-24 overflow-hidden relative">
       <div className="absolute top-0 bottom-0 left-0 w-32 bg-gradient-to-r from-gray-50 dark:from-darkBg to-transparent z-10" />
       <div className="absolute top-0 bottom-0 right-0 w-32 bg-gradient-to-l from-gray-50 dark:from-darkBg to-transparent z-10" />
       
       <div className="mb-12 text-center">
         <h2 className="text-3xl font-heading font-bold dark:text-white">Client <span className="text-cyanMint">Stories</span></h2>
       </div>
